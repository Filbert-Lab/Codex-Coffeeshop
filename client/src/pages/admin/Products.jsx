...
// Inline SVG fallback (no external dependency, never 404)
const FALLBACK_IMG =
  "data:image/svg+xml;utf8," +
  encodeURIComponent(
    `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 40 40">
      <defs><linearGradient id="g" x1="0" y1="0" x2="0" y2="1"><stop offset="0" stop-color="#FBF4E6"/><stop offset="1" stop-color="#F4ECDF"/></linearGradient></defs>
      <rect width="40" height="40" fill="url(#g)"/>
      <g fill="none" stroke="#9C6B3F" stroke-width="1.4" stroke-linecap="round" opacity="0.55">
        <path d="M27 14h2a4 4 0 0 1 0 8h-2"/>
        <path d="M11 14h16v11a4 4 0 0 1-4 4h-8a4 4 0 0 1-4-4z"/>
        <path d="M14 9v3M18 9v3M22 9v3"/>
      </g>
    </svg>`,
  );
    ...
    <div className="p-8">
      ...
      <div className="rounded-2xl overflow-hidden" style={card}>
        {loading ? (
          <div className="p-12 text-center text-codex-muted flex flex-col items-center">
            <div
              ...
              style={{
                borderColor: "rgba(156,107,63,0.3)",
                borderTopColor: "#9C6B3F",
              }}
            />
            ...
            >
              <tr>
                {[
                  ...
                  <th
                    key={h}
                    className="text-left px-5 py-3.5 font-semibold text-[11px] uppercase tracking-wider"
                    style={{ color: "#8C7458" }}
                  >
                    {h}
                  </th>
            ...
            <tbody>
              {products.length === 0 ? (
                <tr>
                  <td
                    colSpan={7}
                    className="text-center py-12 text-codex-muted"
                  >
                    <span className="text-3xl block mb-2 opacity-30">☕</span>No
                    products found
                  </td>
                </tr>
              ) : (
                products.map((p) => (
                  ...
                  >
                    ...
                    <td className="px-5 py-3.5 font-medium max-w-[160px] truncate text-codex-text">
                      {p.name}
                    </td>
                    <td className="px-5 py-3.5 text-[12px] text-codex-muted">
                      {p.category?.name || "—"}
                    </td>
                    <td className="px-5 py-3.5 font-semibold text-codex-accent">
                      {fmt(p.price)}
                    </td>
        ...
        <div
          ...
          style={{ borderTop: "1px solid #E8DCC4", background: "#F4ECDF" }}
        >
          ...
          <div className="flex gap-2">
            <button
              ...
              disabled={page === 1}
              className="text-xs px-3.5 py-1.5 rounded-lg font-medium transition-all disabled:opacity-30"
              style={{
                background: "#FFFFFF",
                border: "1px solid #E8DCC4",
                color: "#5C4530",
      ...
      {modal && (
        ...
        >
          <div
            className="rounded-2xl w-[500px] max-h-[90vh] overflow-y-auto animate-slide-up"
            style={{
              background: "#FFFFFF",
              border: "1px solid #E8DCC4",
              boxShadow:
          ...
          >
            ...
            <div className="p-6">
              {error && (
                <p
                  className="text-red-400 text-sm mb-4 px-4 py-2.5 rounded-xl"
                  style={{
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="flex items-center gap-2 pt-7">
                    <input
                      ...
                      className="w-4 h-4 accent-codex-accent rounded"
                    />
                    <label
                      htmlFor="avail"
                      className="text-sm font-semibold text-codex-text"
                    >
                      Available
                    </label>
                  </div>
