        ...
        {categories.map((cat) => (
          <div
            ...
            onMouseEnter={(e) => {
              ...
              e.currentTarget.style.boxShadow = "0 4px 12px rgba(61,40,23,0.1), 0 16px 32px rgba(61,40,23,0.12)";
            }}
            onMouseLeave={(e) => {
              e.currentTarget.style.border = "1px solid #E8DCC4";
              e.currentTarget.style.boxShadow = "0 1px 3px rgba(61,40,23,0.06), 0 8px 20px rgba(61,40,23,0.06)";
            }}
          >
            <div
            ...
            <div className="flex justify-between items-start mb-3 relative z-10">
              <div
                ...
                style={{
                  background: "linear-gradient(135deg, rgba(156,107,63,0.12), rgba(156,107,63,0.04))",
              ...
              <div className="flex gap-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                <button
                  ...
                  style={{ background: "rgba(99,102,241,0.12)", color: "#5A6FB8" }}
                >
                  Edit
                </button>
                <button
                  ...
                  className="text-[11px] px-2 py-1 rounded-lg font-semibold transition-colors"
                  style={{ background: "rgba(184,84,80,0.12)", color: "#B85450" }}
                >
                  Delete
                </button>
              </div>
        ...
        >
          <div
            ...
            style={{
              background: "#FFFFFF",
              border: "1px solid #E8DCC4",
              boxShadow: "0 8px 24px rgba(61,40,23,0.15), 0 24px 64px rgba(61,40,23,0.18)",
            }}
            ...
            <div className="p-6">
              {error && (
                <p
                  ...
                  style={{ background: "rgba(184,84,80,0.08)", border: "1px solid rgba(184,84,80,0.25)", color: "#B85450" }}
                >
                  {error}
                </p>
              )}
              <form onSubmit={handleSave} className="space-y-4">
                <div>
                  <label className="block text-xs font-semibold uppercase tracking-wider mb-1.5" style={{ color: "#8C7458" }}>
                    Name *
                  </label>
                  <input
                    value={form.name}
                  ...
                  <div className="flex flex-wrap gap-2">
                    {ICONS.map((ic) => (
                      <button
                        ...
                        style={
                          form.icon === ic
                            ? { border: "2px solid #9C6B3F", background: "rgba(156,107,63,0.1)" }
                            : { border: "2px solid #E8DCC4", background: "transparent" }
                        }
                      >
                        {ic}
                      </button>
                ...
                <div className="flex gap-3 pt-2">
                  <button type="button" onClick={() => setModal(null)} className="btn-outline flex-1">
                    Cancel
                  </button>
